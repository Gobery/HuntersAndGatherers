...
import com.github.MoonAndStuff.ability.skill.ultimate.ExampleUltimateSkill;
import com.github.MoonAndStuff.ability.skill.unique.ExampleUniqueSkill;
...
public class AllSkills {
    ...
    //   | Common Skills |
    //   =================
    public static final RegistryObject<LuckyCatch> EXAMPLE_COMMON =
            skillRegistry.register("lucky_catch", LuckyCatch::new);
    ...
    //   | Extra Skills |
    //   ================
    public static final RegistryObject<EfficientBait> EXAMPLE_EXTRA =
            skillRegistry.register("efficient_bait", EfficientBait::new);
